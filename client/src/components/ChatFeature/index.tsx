            ...
            <div className=" flex items-center justify-between my-6">
                ...
                <div className="flex items-center mx-10">
                    ...
                    <span className="mt-7 -ml-3">{
                        usersOnline?.some((user: any) => user?.yourId === receiver?._id || user?.yourId === receiver?.senderId) ? <>
                ...
                <div className="flex items-center text-3xl cursor-pointer text-white">
                    <span className="mx-2 iconsMobile hover:scale-125 hover:text-red-600 ease-in duration-100"><BiSolidPhoneCall /></span>
                    <span className="mx-2 iconsMobile hover:scale-125 hover:text-red-600 ease-in duration-100"><AiOutlineVideoCameraAdd /></span>
                    <span className="mx-2 iconsMobile hover:scale-125 hover:text-red-600 ease-in duration-100"><BiDotsVerticalRounded /></span>
                </div>
            </div>
        </div >
    )
